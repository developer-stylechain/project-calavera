...
function addPrettierToStylelintrc(fileContents) {
  ...
  /* See https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify#Parameters, in particular the `space` parameter we use here to
   ensure the file content formatting persists.
   */

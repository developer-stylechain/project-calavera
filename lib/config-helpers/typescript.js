...
const typescriptTooling = {
  ...
  addTooling: (target) => {
    ...
    } else if (target === "transitional") {
      configFiles = [typescriptConfigFiles[2]];
      dependencies = typescriptTransitionalDependencies;
    }
